...
def get_logo():
    logo_path = Path("chessensei_logo.png")
    if logo_path.exists():
        with open(logo_path, "rb") as f:
            b64 = base64.b64encode(f.read()).decode()
        return f'<img src="data:image/png;base64,{b64}" style="height:56px;object-fit:contain;">'
    return '<span style="font-size:1.4rem;font-weight:900;color:#FFD700;">♟ Chessensei</span>'
